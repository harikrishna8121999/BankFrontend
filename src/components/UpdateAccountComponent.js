...
export default class UpdateAccountComponent extends Component {
    constructor(props){
        super(props)
     ...
     componentDidMount(){
        AccountService.getAccountById(this.state.id).then((res) =>{
            ...
            this.setState({name:accountDetails.name,
     ...
     updateAccount = (e) =>{
         ...
         AccountService.updateAccount(accountDetails, this.state.id).then(res =>{
